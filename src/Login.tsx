...
const SignupForm: React.FC = () => {
  ...
  return (
    <form className="my-8" onSubmit={handleSubmit}>
      ...
      <button
        className="bg-gradient-to-r from-black to-neutral-600 hover:from-black hover:to-neutral-700 block w-full text-white rounded-md h-10 font-medium shadow-[0px_1px_0px_0px_#ffffff40_inset,0px_-1px_0px_0px_#ffffff40_inset]"
        type="submit"
      >
        Sign up &rarr;
        <BottomGradient />
